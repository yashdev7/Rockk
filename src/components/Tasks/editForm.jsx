...
const EditForm = props => {
    ...
    return <Form initialValues={item} onSubmit={onSubmit} render={renderProps => <Dialog title={`Edit ${item.ProductName}`} onClose={cancelEdit} style={{
        maxWidth: "650px"
    }}>
        <FormElement>
            <FieldWrapper>
            ...
            <FieldWrapper>
                ...
                <div className={"k-form-field-wrap"}>
                    <Field id={"Category"} name={"Category"} component={DropDownList} data={categories} textField={"CategoryName"} />
                </div>
            </FieldWrapper>
            <FieldWrapper>
        ...
        <DialogActionsBar layout="start">
            <Button type={"submit"} themeColor={"primary"} disabled={!renderProps.allowSubmit} onClick={renderProps.onSubmit} icon="save" svgIcon={saveIcon}>
                Update
            </Button>
